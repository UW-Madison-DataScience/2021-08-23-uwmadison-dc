...
humandate: "August 23, 25, 27, 30 & September 1, 3 2021"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Trisha Adamus", "Clare Michaud", "Sailendharan Sudakaran", "Sarah Stevens"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Karl Broman", "Sailendharan Sudakaran", "Clare Michaud", "Sarah Stevens", "Steven Warren", "Trisha Adamus", "Scott Wildman", "Chris Endemann", "Erwin Lares"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://pad.carpentries.org/2021-08-23-uwmadison-dc  # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
eventbrite:  161677633153         # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
